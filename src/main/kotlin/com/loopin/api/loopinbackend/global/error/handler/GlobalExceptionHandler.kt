package com.loopin.api.loopinbackend.global.error.handler
...
class GlobalExceptionHandler {
    ...
    private fun handleBizException(e: BizException, request: HttpServletRequest): ResponseEntity<CommonResponse<Void>> {
