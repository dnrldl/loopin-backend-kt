...
import com.loopin.api.loopinbackend.domain.post.service.PostCommandService
import com.loopin.api.loopinbackend.domain.post.service.PostQueryService
...
class PostController(
    ...
    @PostMapping("/create")
    fun createPost(@RequestBody @Valid body: CreatePostRequest): SuccessResponse<CreatePostResult> =
        SuccessResponse.of(postCommandService.createPost(body), SuccessCode.SAVE_SUCCESS)
